...
searchInput.addEventListener('keypress', async (e) => {
    if (event.key === "Enter") {
        ...
        window.location.href = "https://this-is-streamify.onrender.com:8080/search/";    
    }
})
...
function searchResults() {
    ...
    setTimeout( async () => {
        // GET DATA
        const response = await fetch(`https://this-is-streamify.onrender.com:8080/search/input?search=${input}`, { method: "GET" });
